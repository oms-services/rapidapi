# _RapidAPI_ Open Microservice

> Access any valid RapidAPI service.
...
> Call any endpoint established via RAPIDAPI_HOST

##### Action Arguments

| Argument Name    | Type     | Required | Default | Description                                         |
| :--------------- | :------- | :------- | :------ | :-------------------------------------------------- |
| host             | `string` | `true`   | None    | RapidAPI Host header value: `X-RapidAPI-Host`       |
| endpoint         | `string` | `true`   | None    | RapidAPI Host path, such as: /analyze/              |
| args             | `map`    | `false`  | None    | Arguments accepted by the RapidAPI `host` endpoint. |
| RAPIDAPI_API_KEY | `string` | `true`   | None    | RapidAPI Key sent as a header - `X-RapidAPI-Key`    |
...
oms run api \
    ...
    -a endpoint='*****' \
    -a args='*****' \
    -e RAPIDAPI_API_KEY=$RAPIDAPI_API_KEY
```
...
[![Edit rapidapi on CodeSandbox](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/oms-services/rapidapi)
